...
pub fn trigger_schema(name: &str) -> Option<Vec<crate::lsp_tables::SchemaField>> {
    ...
    for (_, s, trigger) in TRIGGER.iter() {
        ...
        let fields: Option<&'static [_]> = match trigger {
            ...
            Trigger::ScopeOrBlock(_, f) => Some(f),
            Trigger::ItemOrBlock(_, f) => Some(f),
            Trigger::IdentifierOrBlock(_, f) => Some(f),
...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    (
        ...
        Block(&[("type", Item(Item::AccoladeType)), ("level", CompareValue)]),
    ),
    (Scopes::Accolade, "accolade_can_have_more_attributes", Boolean),
    (Scopes::Accolade, "accolade_can_spend_attribute", Boolean),
    ...
    (
        Scopes::Character,
        "ai_will_do_contribution",
        Block(&[("target", Scope(Scopes::ProjectContribution)), ("+value", CompareValue)]),
    ),
    ...
    (
        Scopes::Character,
        "amenity_level",
        Block(&[("target", Item(Item::Amenity)), ("+value", CompareValue)]),
    ),
    ...
    (
        ...
        // TODO: target changed from title; verify
    ...
    (Scopes::Character, "appointment_timeout_days", CompareValue),
    (Scopes::LandedTitle, "are_vassal_wars_redirected_to_holder", Removed("1.18.1", "")),
    (Scopes::Army, "army_is_moving", Boolean),
    (Scopes::Army, "army_max_size", CompareValue),
    (Scopes::Army, "army_number_maa_regiments", CompareValue),
    (Scopes::Army, "army_number_maa_regiments_of_base_type", UncheckedTodo),
    (Scopes::Army, "army_number_maa_regiments_of_type", UncheckedTodo),
    ...
    (Scopes::Character, "barter_goods", CompareValue),
    (Scopes::Army, "barter_loot", CompareValue),
    ...
    (Scopes::Character, "can_afford_enact_treasury_budget_costs", Boolean),
    ...
    (Scopes::DynastyHouse, "can_change_house_aspiration", Boolean),
    (
        Scopes::Character,
        "can_create_faction",
    ...
    (Scopes::Character, "can_fund_project_contribution", Scope(Scopes::ProjectContribution)),
    ...
    (Scopes::Character, "can_plan_great_project", Scope(Scopes::GreatProjectType)),
    (
        Scopes::Character,
        "can_plan_great_project_in_province",
        Block(&[
            ("type_name", Scope(Scopes::GreatProjectType)),
            ("province", Scope(Scopes::Province)),
        ]),
    ),
    ...
    (Scopes::Character, "can_vassals_be_attacked", Boolean),
    ...
    (Scopes::Character, "character_men_at_arms_expense_treasury_relative", CompareValue),
    (Scopes::Character, "character_treasury_budget_capacity", CompareValue),
    (Scopes::Character, "character_treasury_new_budget_capacity", CompareValue),
    (Scopes::Confederation, "cohesion", CompareValue),
    (Scopes::Province, "combined_building_level", CompareValue),
    (Scopes::Confederation, "combined_military_strength", CompareValue),
    ...
    (Scopes::ProjectContribution, "contribution_id", Item(Item::ProjectContribution)),
    (Scopes::ProjectContribution, "contribution_is_funded", Boolean),
    (Scopes::ProjectContribution, "contribution_is_required", Boolean),
    (Scopes::Faith, "controls_holy_site", Item(Item::HolySite)),
    (
        Scopes::Faith,
        "controls_holy_site_with_flag",
        Removed("1.19", "replaced with `controls_holy_site_with_parameter`"),
    ),
    (Scopes::Faith, "controls_holy_site_with_parameter", Item(Item::HolySiteParameter)),
    ...
    (
        ...
        Block(&[("*terrain", Item(Item::Terrain))]),
    ),
    ...
    (Scopes::CultureInnovation, "culture_can_know_innovation", Scope(Scopes::Culture)),
    (Scopes::Culture, "culture_has_any_fascination", Boolean),
    ...
    (Scopes::LandedTitle, "custom_title_name", Item(Item::Localization)),
    ...
    (
        Scopes::Character,
        "does_ai_liege_in_vassal_contract_desire_admin_province_obligation_change",
        Boolean,
    ),
    (Scopes::Character, "does_ai_liege_in_vassal_contract_desire_obligation_change", Boolean),
    (
        Scopes::Character,
        "does_ai_subject_in_subject_contract_desire_admin_province_obligation_change",
        Boolean,
    ),
    (Scopes::Character, "does_ai_subject_in_subject_contract_desire_obligation_change", Boolean),
    ...
    (Scopes::GreatProject, "great_project_build_progress", CompareValue),
    (
        Scopes::GreatProject,
        "great_project_construction_phase_is",
    ...
    (Scopes::None, "has_all_variables", Block(&[("+name", Identifier("variable name"))])),
    ...
    (
        Scopes::Character,
        "has_appointment_influence_level_for_title_tier",
    ...
    (Scopes::Character, "has_appointment_level_for_title", Scope(Scopes::LandedTitle)),
    (Scopes::Character, "has_appointment_merit_level_for_title_tier", Scope(Scopes::LandedTitle)),
    (Scopes::Character, "has_appointment_piety_level_for_title_tier", Scope(Scopes::LandedTitle)),
    (
        Scopes::Character,
        "has_appointment_prestige_level_for_title_tier",
        Scope(Scopes::LandedTitle),
    ),
    ...
    (Scopes::DynastyHouse, "has_base_name", Item(Item::Localization)),
    ...
    (Scopes::LandedTitle, "has_coastal_province", Boolean),
    (Scopes::Confederation, "has_cohesion", Boolean),
    (Scopes::Confederation, "has_cohesion_level_parameter", Item(Item::CohesionLevelParameter)),
    (
        Scopes::Character,
    ...
    (Scopes::LandedTitle, "has_custom_title_name", Boolean),
    ...
    (Scopes::DynastyHouse, "has_default_house_aspiration", Boolean),
    ...
    (Scopes::Character, "has_ethnicity", Scope(Scopes::Character)),
    ...
    (
        Scopes::Character,
        "has_first_name",
        ItemOrBlock(Item::Localization, &[("character", Scope(Scopes::Character))]),
    ),
    (
        Scopes::Character,
        "has_first_name_strict",
        ItemOrBlock(Item::Localization, &[("character", Scope(Scopes::Character))]),
    ),
    ...
    (Scopes::Province, "has_great_building", Boolean),
    (Scopes::Province, "has_great_building_slot", Boolean),
    ...
    (
        Scopes::LandedTitle,
        "has_holy_site_flag",
        Removed("1.19", "replaced with `has_holy_site_parameter`"),
    ),
    (Scopes::LandedTitle, "has_holy_site_parameter", Item(Item::HolySiteParameter)),
    ...
    (
        ...
        Item(Item::BooleanHouseAspirationParameter),
    ),
    (Scopes::DynastyHouse, "has_house_head_parameter", Item(Item::BooleanHouseHeadParameter)),
    ...
    (
        ...
        Removed("1.19", "replaced with `has_house_aspiration_parameter`"),
    ),
    ...
    (
        ...
        Item(Item::BooleanHouseRelationParameter),
    ),
    (Scopes::DynastyHouse, "has_house_relation_with", Scope(Scopes::DynastyHouse)),
    ...
    (Scopes::Culture, "has_innovation", ScopeOrItem(Scopes::CultureInnovation, Item::Innovation)),
    (Scopes::Culture, "has_innovation_flag", Item(Item::InnovationFlag)),
    (Scopes::CultureInnovation, "has_innovation_parameter", Item(Item::InnovationParameter)),
    (Scopes::Inspiration, "has_inspiration_type", Item(Item::Inspiration)),
    (Scopes::Confederation, "has_leading_house", Boolean),
    (
        Scopes::Legend,
        "has_legend_chapter",
        ItemOrBlock(
            Item::LegendChapter,
            &[("name", Item(Item::LegendChapter)), ("?localization_key", Item(Item::Localization))],
        ),
    ),
    ...
    (Scopes::None, "has_none_of_variables", Block(&[("+name", Identifier("variable name"))])),
    ...
    (
        Scopes::Character,
        "has_original_first_name",
        ItemOrBlock(Item::Localization, &[("character", Scope(Scopes::Character))]),
    ),
    (
        Scopes::Character,
        "has_original_first_name_strict",
        ItemOrBlock(Item::Localization, &[("character", Scope(Scopes::Character))]),
    ),
    ...
    (
        ...
        "has_participant_group_parameter",
    ...
    (
        ...
        Scope(Scopes::CourtPositionType),
    ),
    (
        Scopes::Character,
    ...
    // TODO: don't allow comparators for "any"
    (
        Scopes::LandedTitle,
        "has_province_with_epidemic",
        Block(&[("+intensity", CompareChoice(&["any", "minor", "major", "apocalyptic"]))]),
    ),
    ...
    (Scopes::Character, "has_realm_law_in_group", Item(Item::LawGroup)),
    (
        Scopes::Character,
        "has_regnal_name",
        ItemOrBlock(Item::Localization, &[("character", Scope(Scopes::Character))]),
    ...
    (Scopes::Province, "has_ruined_great_building", Boolean),
    (Scopes::Character, "has_ruler_objective", Boolean),
    ...
    (Scopes::Character, "has_same_ethnicity_as", Scope(Scopes::Character)),
    (Scopes::Character, "has_same_focus_as", Scope(Scopes::Character)),
    (Scopes::Character, "has_same_government", Scope(Scopes::Character)),
    (Scopes::DynastyHouse, "has_same_house_aspiration_as", Scope(Scopes::DynastyHouse)),
    (
        Scopes::DynastyHouse,
        "has_same_house_power_as",
        Removed("1.19", "replaced with `has_same_house_aspiration_as`"),
    ),
    ...
    (Scopes::Character, "has_treasury", Boolean),
    ...
    (
        Scopes::None,
        "has_variable",
        IdentifierOrBlock("variable name", &[("+name", Identifier("variable name"))]),
    ),
    ...
    (Scopes::CultureInnovation, "innovation_era", Item(Item::CultureEra)),
    (Scopes::CultureInnovation, "innovation_is_regional", Boolean),
    (Scopes::CultureInnovation, "innovation_key", Item(Item::Innovation)),
    ...
    (Scopes::Character, "is_acceptable_fit_for_accolade", Scope(Scopes::Accolade)),
    (Scopes::Character, "is_acclaimed", Boolean),
    (Scopes::Accolade, "is_accolade_active", Removed("1.19", "")),
    ...
    (Scopes::CultureInnovation, "is_ahead_of_time_for_culture", Scope(Scopes::Culture)),
    ...
    (Scopes::Army, "is_barter_army", Boolean),
    (Scopes::Character, "is_betrothed", Boolean),
    (Scopes::Character, "is_bloc_leader_or_bloc_leader_heir_of", Scope(Scopes::Character)),
    ...
    (Scopes::Character, "is_knight_permitted", Scope(Scopes::Character)),
    (Scopes::Character, "is_perfect_fit_for_accolade", Scope(Scopes::Accolade)),
    ...
    (Scopes::LandedTitle, "is_figurehead_title", Boolean),
    ...
    (Scopes::Character, "is_in_debt", Boolean),
    (Scopes::Religion.union(Scopes::Faith), "is_in_family", Item(Item::ReligionFamily)),
    (
        Scopes::Character,
        "is_in_guest_subset",
    ...
    (Scopes::CultureInnovation, "is_known_by_culture", Scope(Scopes::Culture)),
    ...
    (Scopes::Character, "is_no_men_enabled", Boolean),
    ...
    (Scopes::Province, "is_riverside_province", Boolean),
    (Scopes::Province, "is_ruined_building_being_reconstructed", Boolean),
    (Scopes::Character, "is_ruler", Boolean),
    (Scopes::LandedTitle, "is_ruler_de_jure_liege_or_above", Scope(Scopes::Character)),
    ...
    (Scopes::None, "is_title_localization_key_used", Item(Item::Localization)),
    ...
    (Scopes::Character, "is_valid_agent_standard_trigger", Boolean),
    ...
    (Scopes::Character, "is_valid_successor_for_accolade", Removed("1.19", "")),
    ...
    (Scopes::Character, "is_yes_men_enabled", Boolean),
    (
        Scopes::Character,
        "join_faction_chance",
    ...
    (Scopes::Character, "long_term_treasury", CompareValueWarnEq),
    (Scopes::Character, "long_term_treasury_maximum", CompareValueWarnEq),
    (Scopes::Character, "long_term_treasury_or_gold", CompareValueWarnEq),
    (Scopes::Character, "lowest_skill", CompareValue),
    (Scopes::Character, "lowest_skill_including_prowess", CompareValue),
    ...
    (Scopes::Character, "max_accolades", CompareValue),
    (Scopes::Character, "max_active_accolades", Removed("1.19", "replaced with `max_accolades`")),
    ...
    (Scopes::Character, "merit", CompareValueWarnEq),
    (Scopes::Character, "merit_level", CompareValue),
    (Scopes::Character, "military_power", CompareValueWarnEq),
    (Scopes::LandedTitle, "min_appointment_level", CompareValue),
    (Scopes::Character, "min_appointment_tier", CompareValue),
    (Scopes::Character, "min_title_maa_tier", CompareValue),
    (
        Scopes::Character,
    ...
    (Scopes::Character, "monthly_character_men_at_arms_expense_treasury", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_balance", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_income", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_income_long_term", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_income_reserved", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_income_short_term", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_income_war_chest", CompareValueWarnEq),
    (Scopes::Character, "monthly_character_treasury_variable_income", CompareValueWarnEq),
    ...
    (Scopes::Character, "num_accolades", CompareValue),
    (Scopes::Character, "num_active_accolades", Removed("1.19", "replaced with `num_accolades`")),
    ...
    (
        ...
        Block(&[("target", Item(Item::CultureEra)), ("+value", CompareValue)]),
    ),
    ...
    (Scopes::Character, "num_inactive_accolades", Removed("1.19", "replaced with `num_accolades`")),
    ...
    (
        Scopes::Character,
        "num_sinful_traits",
        BlockOrCompareValue(&[("+value", CompareValue), ("target", Scope(Scopes::Faith))]),
    ),
    ...
    (Scopes::Accolade, "primary_tier", Removed("1.19", "")),
    (
        Scopes::Province,
    ...
    (
        ...
        Block(&[("target", Scope(Scopes::Epidemic)), ("+value", CompareValueWarnEq)]),
    ),
    ...
    (Scopes::Character, "realm_law_group_at_maximum_level", Item(Item::LawGroup)),
    (Scopes::Character, "realm_law_group_at_minimum_level", Item(Item::LawGroup)),
    (
        Scopes::Character,
    ...
    (
        ...
        "region_is_adjacent",
        Scope(Scopes::GeographicalRegion),
    ),
    (
        Scopes::GeographicalRegion.union(Scopes::SituationSubRegion),
    ...
    (Scopes::Character, "reserved_treasury", CompareValueWarnEq),
    (Scopes::Character, "reserved_treasury_maximum", CompareValueWarnEq),
    (Scopes::Character, "reserved_treasury_or_gold", CompareValueWarnEq),
    (
        Scopes::Character,
    ...
    (Scopes::Accolade, "secondary_tier", Removed("1.19", "")),
    ...
    (Scopes::Character, "short_term_treasury", CompareValueWarnEq),
    (Scopes::Character, "short_term_treasury_maximum", CompareValueWarnEq),
    (Scopes::Character, "short_term_treasury_or_gold", CompareValueWarnEq),
    ...
    (
        ...
        Removed("1.18", "replaced with `should_notify_can_join_activity`"),
    ),
    (
        Scopes::Character,
        "should_notify_can_join_activity",
        ScopeOrItem(Scopes::ActivityType, Item::ActivityType),
    ),
    ...
    (Scopes::Situation, "situation_top_phase_days_since_start_date", CompareValue),
    (Scopes::Situation, "situation_top_phase_days_until_end_date", CompareValue),
    (Scopes::Situation, "situation_top_phase_end_date", CompareDate),
    (Scopes::Situation, "situation_top_phase_start_date", CompareDate),
    ...
    (Scopes::Character, "starting_gold_by_income", CompareValue),
    (
        Scopes::Character,
        "static_group_filter",
        Block(&[
    ...
    (Scopes::SituationSubRegion, "sub_region_current_phase_days_since_start_date", CompareValue),
    (Scopes::SituationSubRegion, "sub_region_current_phase_days_until_end_date", CompareValue),
    (Scopes::SituationSubRegion, "sub_region_current_phase_end_date", CompareDate),
    (Scopes::SituationSubRegion, "sub_region_current_phase_start_date", CompareDate),
    ...
    (
        Scopes::Character,
        "subject_contract_obligation_level_can_be_increased",
        Item(Item::SubjectContract),
    ),
    (Scopes::Character, "subject_standing", CompareValue),
    (
        Scopes::Character,
    ...
    (Scopes::Character, "title_law_group_at_maximum_level", Item(Item::LawGroup)),
    (Scopes::Character, "title_law_group_at_minimum_level", Item(Item::LawGroup)),
    ...
    (Scopes::Character, "treasury", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_allocation_excess", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_allocation_military", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_allocation_ministries", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_allocation_salaries", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_base_rate_military", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_base_rate_ministries", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_base_rate_salaries", CompareValueWarnEq),
    (Scopes::Character, "treasury_budget_enact_date", CompareDate),
    (Scopes::Character, "treasury_days_since_budget_enact_date", CompareValue),
    (Scopes::Character, "treasury_debt_level", CompareValue),
    (Scopes::Character, "treasury_months_since_budget_enact_date", CompareValue),
    (Scopes::Character, "treasury_or_gold", CompareValueWarnEq),
    (Scopes::Character, "treasury_years_since_budget_enact_date", CompareValue),
    (
        Scopes::Character,
        "tributary_contract_obligation_level_can_be_decreased",
        Item(Item::SubjectContract),
    ),
    (
        Scopes::Character,
    ...
    (Scopes::Character, "war_chest_treasury", CompareValueWarnEq),
    (Scopes::Character, "war_chest_treasury_maximum", CompareValueWarnEq),
    (Scopes::Character, "war_chest_treasury_or_gold", CompareValueWarnEq),
    (
        Scopes::War,
        "war_contribution",
        Block(&[("target", Scope(Scopes::Character)), ("+value", CompareValue)]),
    ...
    (Scopes::Character, "year_character_treasury_income", CompareValueWarnEq),
    (Scopes::Character, "year_character_treasury_variable_income", CompareValueWarnEq),
    ...
    (Scopes::Character, "yearly_character_men_at_arms_expense_treasury", CompareValueWarnEq),
    (Scopes::Character, "yearly_character_treasury_balance", CompareValueWarnEq),
...
const TRIGGER_COMPLEX: &[(Scopes, &str, ArgumentValue, Scopes)] = {
    ...
    &[
        ...
        (
            Scopes::Character,
            "ai_will_do_contribution",
            Scope(Scopes::ProjectContribution),
            Scopes::Value,
        ),
        (
            Scopes::Character,
...
/// Returns `None` for triggers that accept free-form values or items.
