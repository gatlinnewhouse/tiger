...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Country, "has_presence_in", UncheckedTodo), // TODO: Multiple scopes are valid (region, continent, and so on)
    ...
    (Scopes::None, "is_tutorial_lesson_step_completed", UncheckedTodo), // TODO: check for Lesson and Step key: <tutorial_lesson>:<tutorial_step>
    (Scopes::Location, "is_unified_culture", Boolean),
