...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Character, "set_can_inherit", Boolean),
    (Scopes::Character, "set_can_marry", Boolean),
    ...
    (Scopes::Governorship, "raise_legion", Vbc(validate_raise_legion)),
    ...
    (Scopes::Country, "allow_trade_goods", Unchecked),
    (Scopes::Country, "call_omen", Unchecked),
    ...
    (Scopes::Country, "create_character", Vbc(validate_create_character)),
    ...
    (Scopes::Country, "disallow_trade_goods", Unchecked),
    ...
    (Scopes::Country, "remove_party_leadership", Unchecked),
    ...
    (Scopes::Country, "start_character_interaction", Unchecked),
    ...
    (Scopes::Legion.union(Scopes::Country), "create_unit", Vbc(validate_create_unit)),
    ...
    (Scopes::War, "war_score_value", Vb(validate_war_score_value)),
    ...
    (Scopes::Province, "create_country", Vbc(validate_create_country)),
    ...
    (Scopes::CountryCulture, "set_levy_template", Item(Item::LevyTemplate)),
