...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Character, "add_career_length", Vb(validate_career_length)),
    ...
    (Scopes::Character, "add_character_role", Vv(validate_add_character_role)),
    ...
    (Scopes::Culture, "add_cultural_taboo", Item(Item::Goods)),
    ...
    (Scopes::Country, "add_declared_interest", Removed("1.13", "replaced with `add_involvement`")),
    ...
    (
        Scopes::Country,
        "add_involvement",
        TargetValue("strategic_region", Scopes::StrategicRegion, "value"),
    ),
    ...
    (Scopes::State.union(Scopes::StateRegion), "add_resource_potential", Item(Item::BuildingType)),
    (Scopes::InterestGroup, "add_ruling_interest_group", Boolean),
    (Scopes::StateRegion, "add_state_trait", Item(Item::StateTrait)),
    (Scopes::Country, "add_supply_ships", ScriptValue),
    ...
    (
        Scopes::State.union(Scopes::StateRegion),
        "change_resource_potential",
        ItemValue("type", Item::BuildingType, "amount"),
    ),
    ...
    (Scopes::Country, "clear_ownership_transfer_fleet", Yes),
    ...
    (Scopes::Country, "create_ship", Vb(validate_create_ship)),
    ...
    (Scopes::None, "custom_label_no_bullet", ControlOrLabel),
    (Scopes::None, "custom_tooltip", ControlOrLabel),
    (Scopes::None, "custom_tooltip_no_bullet", ControlOrLabel),
    (Scopes::Ship, "damage_ship_hull", ScriptValue),
    (Scopes::Ship, "damage_ship_hull_percent", ScriptValue),
    ...
    (Scopes::Country, "disable_temporary_hostilities", Vb(validate_temporary_hostilities)),
    ...
    (Scopes::Country, "enable_temporary_hostilities", Vb(validate_temporary_hostilities)),
    ...
    (Scopes::Ship, "kill_crew", ScriptValue),
    (Scopes::Ship, "kill_crew_percent", ScriptValue),
    ...
    (Scopes::Culture, "remove_cultural_taboo", Item(Item::Goods)),
    ...
    (Scopes::Character, "replace_character_roles", Vb(validate_replace_character_roles)),
    ...
    (Scopes::Character, "retire_character_if_should_be_culled", Vbv(validate_kill_character)),
    ...
    (Scopes::Character, "set_as_adult", Yes),
    (Scopes::Ship, "set_as_flagship", Boolean),
    ...
    (Scopes::Character, "set_career_length", Vb(validate_career_length)),
    ...
    (Scopes::Character, "set_first_name", Item(Item::Localization)),
    ...
    (Scopes::Character, "set_home_state", Scope(Scopes::State)),
    ...
    (Scopes::Character, "set_is_noble", Boolean),
    (Scopes::DiplomaticPlay, "set_key", Item(Item::Localization)),
    (Scopes::Character, "set_last_name", Item(Item::Localization)),
    ...
    (Scopes::Culture, "set_name_format", Choice(&["first_last", "last_first"])),
    ...
    (Scopes::Ship, "set_ship_owner", Scope(Scopes::Country)),
    (Scopes::Ship, "set_ship_owner_multiple", Scope(Scopes::Country)),
    ...
    (
        Scopes::StateRegion,
        "start_harvest_condition_with_params",
        Vb(validate_start_harvest_condition),
    ),
    ...
    (Scopes::Character, "unassign_from_formation", Yes),
