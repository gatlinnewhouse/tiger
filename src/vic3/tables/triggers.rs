...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::PoliticalMovement, "is_being_bolstered", Boolean),
    (Scopes::PoliticalMovement, "is_being_suppressed", Boolean),
    ...
    (Scopes::None, "is_theme_selected", Item(Item::Theme)),
    ...
    (Scopes::TreatyArticle, "is_treaty_article_in_danger", Boolean),
