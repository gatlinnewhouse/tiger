...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Ship, "ai_ship_value", CompareValue),
    ...
    (Scopes::Ship, "armor", CompareValue),
    (
        Scopes::Country,
    ...
    (Scopes::StrategicRegion, "can_have_declared_interest_here", Removed("1.13", "")),
    ...
    (
        ...
        Removed("1.13", "replaced with `country_ship_type_fraction`"),
    ),
    ...
    (Scopes::Country, "country_ship_type_fraction", UncheckedTodo),
    (
        Scopes::Country,
        "country_ship_type_fraction",
        Block(&[("target", Scope(Scopes::ShipType)), ("value", CompareValue)]),
    ),
    (Scopes::Country, "country_tier", ItemOrCompareValue(Item::CountryTier)),
    (Scopes::Country, "country_turmoil", CompareValue),
    (Scopes::Ship, "crew", CompareValue),
    (Scopes::Ship, "crew_percent", CompareValue),
    ...
    (Scopes::Ship, "days_obsolete", CompareValue),
    ...
    (
        ...
        Removed("1.13", "replaced with `formation_ship_type_fraction`"),
    ),
    (
        Scopes::MilitaryFormation,
    ...
    (Scopes::Country, "has_any_naval_only_hostilities", Boolean),
    (Scopes::Country, "has_any_strait_control", Scope(Scopes::Country)),
    (Scopes::Country, "has_any_strait_province", Scope(Scopes::Country)),
    ...
    (Scopes::Country, "has_decreasing_interests", Removed("1.13", "")),
    ...
    (Scopes::MilitaryFormation, "has_naval_mission_with_invalid_area", Boolean),
    ...
    (
        Scopes::Country.union(Scopes::Market).union(Scopes::State),
        "has_port",
        Removed("1.13", "replaced with `has_port_market` and `has_port_state`"),
    ),
    (Scopes::Country, "has_port_country", Boolean),
    (Scopes::Market, "has_port_market", Boolean),
    (Scopes::State, "has_port_state", Boolean),
    ...
    (
        ...
        "has_region_stance",
        Block(&[
            ("region", Scope(Scopes::StrategicRegion)),
            ("stance", Item(Item::AiStrategicRegionStanceType)),
        ]),
    ),
    ...
    (Scopes::Character, "has_role_of_type", Item(Item::CharacterArchetype)),
    ...
    (Scopes::MilitaryFormation, "has_ship_outside_max_port_distance", Boolean),
    ...
    (
        ...
        Block(&[("strategic_region", Scope(Scopes::StrategicRegion)), ("value", CompareValue)]),
    ),
    ...
    (
        Scopes::Country,
        "highest_overlapping_interest_tier",
        Block(&[("target", Scope(Scopes::Country)), ("value", CompareValue)]),
    ),
    (Scopes::Country, "highest_secession_progress", CompareValue),
    (Scopes::Ship, "hit_points", CompareValue),
    (Scopes::Ship, "hit_points_percent", CompareValue),
    ...
    (Scopes::Invasion, "invasion_has_marines", Boolean),
    ...
    (Scopes::Character.union(Scopes::Ship), "is_attacker_in_battle", Boolean),
    (Scopes::CharacterRole, "is_auto_assigned", Boolean),
    (Scopes::Country, "is_banning_goods", ScopeOrItem(Scopes::Goods, Item::Goods)),
    (Scopes::PoliticalMovement, "is_being_bolstered", Boolean),
    (Scopes::State, "is_being_bombarded", Boolean),
    ...
    (Scopes::CharacterRole, "is_character_role", Item(Item::CharacterRole)),
    (Scopes::CharacterRole, "is_character_role_type", Item(Item::CharacterArchetype)),
    ...
    (Scopes::Ship, "is_damaged", Boolean),
    (Scopes::Character.union(Scopes::Ship), "is_defender_in_battle", Boolean),
    (
        Scopes::TreatyArticle.union(Scopes::TreatyArticleOptions),
        "is_desired_by",
    ...
    (Scopes::MilitaryFormation, "is_doing_piracy_in_region", Scope(Scopes::StrategicRegion)),
    ...
    (Scopes::Ship, "is_flagship", Boolean),
    ...
    (Scopes::Character.union(Scopes::Ship), "is_in_battle", Boolean),
    ...
    (Scopes::Ship, "is_in_port", Boolean),
    ...
    (Scopes::InterestMarker, "is_interest_active", Removed("1.13", "")),
    (Scopes::Character, "is_interest_group_leader", Boolean),
    (
        Scopes::Character.union(Scopes::InterestGroup),
        "is_interest_group_type",
        Item(Item::InterestGroup),
    ),
    (Scopes::MilitaryFormation, "is_invalid_naval_mission_grace_period_active", Boolean),
    ...
    (Scopes::Country, "is_local_country", Scope(Scopes::StrategicRegion)),
    ...
    (Scopes::Invasion, "is_naval_invasion", Boolean),
    (
        Scopes::None,
    ...
    (Scopes::Character, "is_noble", Boolean),
    (
        Scopes::Country
            .union(Scopes::State)
            .union(Scopes::StateRegion)
    ...
    (Scopes::Character, "is_ruler", Removed("1.13", "replaced by three `is_ruler_of_` triggers")),
    (Scopes::Character, "is_ruler_of_any_country", Boolean),
    (Scopes::Character, "is_ruler_of_other_country", Boolean),
    (Scopes::Character, "is_ruler_of_own_country", Boolean),
    ...
    (Scopes::Ship, "is_ship_type", Scope(Scopes::ShipType)),
    ...
    (Scopes::Character, "lifetime_piracy_income", CompareValue),
    (
        Scopes::None,
        "list_size",
        Block(&[("name", Identifier("list name")), ("value", CompareValue)]),
    ...
    (Scopes::State, "loyalists", CompareValue),
    ...
    (Scopes::Country, "max_num_declared_interests", Removed("1.13", "")),
    (Scopes::Country, "military_ship_maintenance_fulfillment", CompareValue),
    ...
    (Scopes::Country, "num_declared_interests", Removed("1.13", "")),
    ...
    (Scopes::Country, "potential_income", CompareValue),
    ...
    (Scopes::Ship, "power_projection_value", CompareValue),
    (
        Scopes::PowerBloc,
    ...
    (Scopes::Character, "primary_role", Item(Item::CharacterRole)),
    ...
    (
        ...
        Block(&[("?role", Item(Item::CharacterRole)), ("years", CompareValue)]),
    ),
    (
        Scopes::StateRegion,
    ...
    (Scopes::CharacterRole, "role_priority", CompareValue),
    ...
    (Scopes::Country, "ship_modification_market_demand_ratio", UncheckedTodo),
    (
        Scopes::Country,
        "should_set_wargoal",
    ...
    (Scopes::CharacterRole, "spawns_characters_to_pool", Boolean),
    (Scopes::Ship, "speed", CompareValue),
    ...
    (Scopes::Country, "supply_ship_maintenance_fulfillment", CompareValue),
    ...
    (Scopes::Country, "tax_waste", CompareValue),
    ...
    (Scopes::Treaty, "was_coerced_with_naval_threat", Boolean),
...
const TRIGGER_COMPLEX: &[(Scopes, &str, ArgumentValue, Scopes)] = {
    ...
    &[
        ...
        (Scopes::Country, "region_score", Scope(Scopes::StrategicRegion), Scopes::Value),
        (
            Scopes::JournalEntry,
            "scripted_bar_progress",
