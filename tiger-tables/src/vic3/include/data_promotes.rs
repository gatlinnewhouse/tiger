&[
    ...
    ("AccessActor", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(Ship)),
    ...
    ("AccessAttackerBattleParticipant", Vic3(NavalBattle), Args::Args(&[]), Vic3(NavalBattleParticipant)),
    ...
    ("AccessAttackerSideCombatShip", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(CombatShip)),
    ("AccessBattle", Scope, Args::Args(&[]), Vic3(Battle)),
    ("AccessBattle", Vic3(Character), Args::Args(&[]), Vic3(Battle)),
    ("AccessBattleCondition", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(NavalBattleCondition)),
    ...
    ("AccessCharacter", Vic3(CharacterPanel), Args::Args(&[]), Vic3(Character)),
    ("AccessCharacterRole", Scope, Args::Args(&[]), Vic3(CharacterRole)),
    ...
    ("AccessCountry", Vic3(NavalBattleParticipant), Args::Args(&[]), Vic3(Country)),
    ...
    ("AccessDefenderBattleParticipant", Vic3(NavalBattle), Args::Args(&[]), Vic3(NavalBattleParticipant)),
    ...
    ("AccessDefenderSideCombatShip", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(CombatShip)),
    ...
    ("AccessFormation", Vic3(MilitaryFormationWrapped), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("AccessInterestTierType", Scope, Args::Args(&[]), Vic3(InterestTierType)),
    ...
    ("AccessNavalBattle", Scope, Args::Args(&[]), Vic3(NavalBattle)),
    ("AccessNavalMission", Scope, Args::Args(&[]), Vic3(NavalMission)),
    ("AccessNavalMissionType", Scope, Args::Args(&[]), Vic3(NavalMissionType)),
    ...
    ("AccessShip", Scope, Args::Args(&[]), Vic3(Ship)),
    ("AccessShipDesignerPopup", Vic3(PopupManager), Args::Args(&[]), Vic3(ShipDesignerPopup)),
    ("AccessShipGroup", Scope, Args::Args(&[]), Vic3(ShipGroup)),
    ("AccessShipModificationType", Scope, Args::Args(&[]), Vic3(ShipModificationType)),
    ("AccessShipType", Scope, Args::Args(&[]), Vic3(ShipType)),
    ...
    ("AccessStrait", Scope, Args::Args(&[]), Vic3(Strait)),
    ("AccessStraitDefinition", Scope, Args::Args(&[]), Vic3(StraitDefinition)),
    ...
    ("AccessTarget", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(Ship)),
    ...
    ("GetAIStrategicRegionStanceTypeIn", Vic3(Country), Args::Args(&[DType(Unknown)]), Vic3(AIStrategicRegionStanceType)),
    ...
    ("GetActiveSelection", Vic3(ShipList), Args::Args(&[]), Vic3(ShipSelection)),
    ("GetActor", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(Ship)),
    ...
    ("GetArmyFormation", Vic3(TransportPlannerPopup), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetAttacker", Vic3(NavalBattle), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetAttackerModifier", Vic3(NavalBattle), Args::Args(&[]), Vic3(Modifier)),
    ("GetAttackerShipViewer", Vic3(NavalBattlePanel), Args::Args(&[]), Vic3(ShipViewer)),
    ("GetAttackerSide", Vic3(Battle), Args::Args(&[]), Vic3(BattleSide)),
    ("GetAttackerSide", Vic3(NavalBattle), Args::Args(&[]), Vic3(NavalBattleSide)),
    ("GetAttackerSideCombatShip", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(CombatShip)),
    ...
    ("GetBattle", Vic3(NavalBattleMarker), Args::Args(&[]), Vic3(NavalBattle)),
    ("GetBattle", Vic3(NavalBattlePanel), Args::Args(&[]), Vic3(NavalBattle)),
    ("GetBattle", Vic3(PastBattleMarker), Args::Args(&[]), Vic3(Battle)),
    ("GetBattleCondition", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(NavalBattleCondition)),
    ("GetBattleCondition", Vic3(NavalBattle), Args::Args(&[]), Vic3(NavalBattleCondition)),
    ...
    ("GetCharacter", Vic3(CharacterPanel), Args::Args(&[]), Vic3(Character)),
    ("GetCharacter", Vic3(EventIcon), Args::Args(&[]), Vic3(Character)),
    ("GetCharacter", Vic3(PotentialLeaderIdeology), Args::Args(&[]), Vic3(Character)),
    ("GetCharacterFilter", Vic3(PopsOverviewPanel), Args::Args(&[]), Vic3(CharacterFilter)),
    ("GetCharacterFilter", Vic3(StatesPanel), Args::Args(&[]), Vic3(CharacterFilter)),
    ("GetCharacterModifier", Vic3(CharacterRole), Args::Args(&[]), Vic3(Modifier)),
    ("GetCharacterRole", Scope, Args::Args(&[]), Vic3(CharacterRole)),
    ...
    ("GetClosestFriendlyPort", Vic3(Country), Args::Args(&[DType(Unknown)]), Vic3(Building)),
    ...
    ("GetCommandModifier", Vic3(NavalMissionType), Args::Args(&[]), Vic3(Modifier)),
    ("GetCommander", Vic3(BattleSide), Args::Args(&[]), Vic3(Character)),
    ("GetCommander", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(Character)),
    ("GetCommander", Vic3(NavalBattleSide), Args::Args(&[]), Vic3(Character)),
    ...
    ("GetCompany", Vic3(Character), Args::Args(&[]), Vic3(Company)),
    ...
    ("GetConstructionGoodsModifier", Vic3(ShipModificationType), Args::Args(&[]), Vic3(Modifier)),
    ("GetConstructionGoodsModifier", Vic3(ShipType), Args::Args(&[]), Vic3(Modifier)),
    ...
    ("GetCountry", Vic3(NavalBattleSide), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetCountry", Vic3(Ship), Args::Args(&[]), Vic3(Country)),
    ("GetCountry", Vic3(ShipConstruction), Args::Args(&[]), Vic3(Country)),
    ("GetCountry", Vic3(ShipTemplate), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetCurrentInterestTierTypeIn", Vic3(Country), Args::Args(&[DType(Unknown)]), Vic3(InterestTierType)),
    ...
    ("GetCurrentShipType", Vic3(ShipDesignerPopup), Args::Args(&[]), Vic3(ShipType)),
    ...
    ("GetDebugExampleShip", Vic3(NavalBattleSide), Args::Args(&[]), Vic3(CombatShip)),
    ...
    ("GetDefaultConstructionFleet", Vic3(Country), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetDefaultGoods", Vic3(PopNeed), Args::Args(&[]), Vic3(Goods)),
    ("GetDefaultOutputGoods", Vic3(Building), Args::Args(&[]), Vic3(Goods)),
    ("GetDefaultTemplateForFleetOfType", Vic3(ShipTemplateList), Args::Args(&[DType(Unknown), DType(Unknown)]), Vic3(ShipTemplate)),
    ("GetDefaultTemplateOfType", Vic3(ShipTemplateList), Args::Args(&[DType(Unknown)]), Vic3(ShipTemplate)),
    ("GetDefender", Vic3(Battle), Args::Args(&[]), Vic3(Country)),
    ("GetDefender", Vic3(NavalBattle), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetDefenderModifier", Vic3(NavalBattle), Args::Args(&[]), Vic3(Modifier)),
    ("GetDefenderShipViewer", Vic3(NavalBattlePanel), Args::Args(&[]), Vic3(ShipViewer)),
    ("GetDefenderSide", Vic3(Battle), Args::Args(&[]), Vic3(BattleSide)),
    ("GetDefenderSide", Vic3(NavalBattle), Args::Args(&[]), Vic3(NavalBattleSide)),
    ("GetDefenderSideCombatShip", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(CombatShip)),
    ...
    ("GetDefinition", Vic3(Strait), Args::Args(&[]), Vic3(StraitDefinition)),
    ("GetDemandedWarGoal", Vic3(DiplomaticDemand), Args::Args(&[]), Vic3(WarGoalDraft)),
    ("GetDestinationData", Vic3(MapListOption), Args::Args(&[]), Vic3(MapListMilitaryFormationOption)),
    ...
    ("GetDistanceToPortModifier", Vic3(ShipType), Args::Args(&[]), Vic3(Modifier)),
    ...
    ("GetFilterOfGroup", Vic3(ShipList), Args::Args(&[DType(Unknown)]), Vic3(ShipFilter)),
    ("GetFilteredGoodsList", Vic3(MarketPanel), Args::Args(&[DType(Vic3(FoodSecurityFilter))]), Vic3(GoodsList)),
    ("GetFirstController", Vic3(Strait), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetFirstLandEndpoint", Vic3(StraitDefinition), Args::Args(&[]), Vic3(Province)),
    ("GetFirstMilitaryFormation", Vic3(FleetFormationMarker), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetFirstSeaEndpoint", Vic3(StraitDefinition), Args::Args(&[]), Vic3(Province)),
    ("GetFirstSeaNode", Vic3(Strait), Args::Args(&[]), Vic3(Province)),
    ...
    ("GetFirstState", Vic3(Strait), Args::Args(&[]), Vic3(State)),
    ...
    ("GetFlagship", Vic3(Country), Args::Args(&[]), Vic3(Ship)),
    ("GetFlagship", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(Ship)),
    ("GetFleet", Vic3(Invasion), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetFleet", Vic3(NavalMission), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetFleet", Vic3(Ship), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetFleet", Vic3(ShipConstruction), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetFleet", Vic3(ShipList), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetFormation", Vic3(NavalBattleSide), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetGroup", Vic3(Ship), Args::Args(&[]), Vic3(ShipGroup)),
    ("GetGroup", Vic3(ShipType), Args::Args(&[]), Vic3(ShipGroup)),
    ...
    ("GetHQ", Vic3(MapListMilitaryFormationOption), Args::Args(&[]), Vic3(Hq)),
    ...
    ("GetHighlightedBattleEventLogEntry", Vic3(NavalBattlePanel), Args::Args(&[]), Vic3(BattleLogEntry)),
    ("GetHolder", Vic3(WarGoal), Args::Args(&[]), Vic3(Country)),
    ("GetHolder", Vic3(WarGoalDraft), Args::Args(&[]), Vic3(Country)),
    ("GetHolding", Vic3(Character), Args::Args(&[]), Vic3(Building)),
    ...
    ("GetHomeRegion", Vic3(Character), Args::Args(&[]), Vic3(StateRegion)),
    ("GetHomeState", Vic3(Character), Args::Args(&[]), Vic3(State)),
    ...
    ("GetInterestTierType", Scope, Args::Args(&[]), Vic3(InterestTierType)),
    ...
    ("GetInvasion", Vic3(NavalBattle), Args::Args(&[]), Vic3(Invasion)),
    ...
    ("GetLoser", Vic3(NavalBattle), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetMapModeList", Vic3(SeaRegionPanel), Args::Args(&[]), Vic3(MapModeList)),
    ("GetMapModeList", Vic3(SocietyPanel), Args::Args(&[]), Vic3(MapModeList)),
    ("GetMapModeList", Vic3(StrategicRegionPanel), Args::Args(&[]), Vic3(MapModeList)),
    ("GetMarinesGroup", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(CombatUnitGroup)),
    ...
    ("GetMaterielGoodsModifier", Vic3(ShipType), Args::Args(&[]), Vic3(Modifier)),
    ...
    ("GetModificationTypeNew", Vic3(Ship), Args::Args(&[DType(Unknown)]), Vic3(ShipModificationType)),
    ("GetModificationTypeOld", Vic3(Ship), Args::Args(&[DType(Unknown)]), Vic3(ShipModificationType)),
    ...
    ("GetModifier", Vic3(NavalMissionType), Args::Args(&[]), Vic3(Modifier)),
    ("GetModifier", Vic3(PowerBloc), Args::Args(&[]), Vic3(Modifier)),
    ("GetModifier", Vic3(Ship), Args::Args(&[]), Vic3(Modifier)),
    ("GetModifier", Vic3(ShipModificationType), Args::Args(&[]), Vic3(Modifier)),
    ("GetModifier", Vic3(ShipTemplate), Args::Args(&[]), Vic3(Modifier)),
    ("GetModifier", Vic3(ShipType), Args::Args(&[]), Vic3(Modifier)),
    ...
    ("GetMostCommonShipTypeOfGroup", Vic3(ShipList), Args::Args(&[DType(Unknown)]), Vic3(ShipType)),
    ("GetNavalBattle", Scope, Args::Args(&[]), Vic3(NavalBattle)),
    ("GetNavalBattle", Vic3(PastNavalBattleMarker), Args::Args(&[]), Vic3(NavalBattle)),
    ("GetNavalBattle", Vic3(Ship), Args::Args(&[]), Vic3(NavalBattle)),
    ("GetNavalMission", Scope, Args::Args(&[]), Vic3(NavalMission)),
    ("GetNavalMission", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(NavalMission)),
    ("GetNavalMissionData", Vic3(MapListOption), Args::Args(&[]), Vic3(MapListNavalMissionOption)),
    ("GetNavalMissionType", Scope, Args::Args(&[]), Vic3(NavalMissionType)),
    ...
    ("GetNextLevel", Vic3(ShipVeterancyLevel), Args::Args(&[]), Vic3(ShipVeterancyLevel)),
    ...
    ("GetOriginFormation", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(MilitaryFormation)),
    ("GetOtherController", Vic3(Strait), Args::Args(&[DType(Unknown)]), Vic3(Country)),
    ...
    ("GetOtherState", Vic3(Strait), Args::Args(&[DType(Unknown)]), Vic3(State)),
    ...
    ("GetPrimaryRole", Vic3(Character), Args::Args(&[]), Vic3(CharacterRole)),
    ...
    ("GetProvince", Vic3(NavalBattle), Args::Args(&[]), Vic3(Province)),
    ("GetProvince", Vic3(NavalMissionMarker), Args::Args(&[]), Vic3(Province)),
    ("GetProvince", Vic3(SeaNodeMarker), Args::Args(&[]), Vic3(Province)),
    ...
    ("GetRepair", Vic3(Ship), Args::Args(&[]), Vic3(ShipConstruction)),
    ...
    ("GetRetrofit", Vic3(Ship), Args::Args(&[]), Vic3(ShipConstruction)),
    ...
    ("GetSeaRegion", Vic3(MapListNavalMissionOption), Args::Args(&[]), Vic3(Province)),
    ("GetSecondController", Vic3(Strait), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetSecondLandEndpoint", Vic3(StraitDefinition), Args::Args(&[]), Vic3(Province)),
    ...
    ("GetSecondSeaEndpoint", Vic3(StraitDefinition), Args::Args(&[]), Vic3(Province)),
    ("GetSecondSeaNode", Vic3(Strait), Args::Args(&[]), Vic3(Province)),
    ("GetSecondState", Vic3(DiplomaticAction), Args::Args(&[]), Vic3(State)),
    ("GetSecondState", Vic3(DiplomaticActionWindow), Args::Args(&[]), Vic3(State)),
    ("GetSecondState", Vic3(Strait), Args::Args(&[]), Vic3(State)),
    ...
    ("GetSelectedFleet", Vic3(TransportPlannerPopup), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetSelectedModification", Vic3(ShipDesignerModSlot), Args::Args(&[]), Vic3(ShipModificationType)),
    ...
    ("GetShip", Scope, Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(Article), Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(ArticleDraft), Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(CombatShip), Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(ShipChangeNamePopup), Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(ShipConstruction), Args::Args(&[]), Vic3(Ship)),
    ("GetShip", Vic3(ShipPanel), Args::Args(&[]), Vic3(Ship)),
    ("GetShipGroup", Scope, Args::Args(&[]), Vic3(ShipGroup)),
    ("GetShipList", Vic3(Country), Args::Args(&[]), Vic3(ShipList)),
    ("GetShipList", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(ShipList)),
    ("GetShipModificationType", Scope, Args::Args(&[]), Vic3(ShipModificationType)),
    ("GetShipTemplate", Vic3(ShipConstruction), Args::Args(&[]), Vic3(ShipTemplate)),
    ("GetShipType", Scope, Args::Args(&[]), Vic3(ShipType)),
    ("GetShipType", Vic3(ShipConstruction), Args::Args(&[]), Vic3(ShipType)),
    ("GetShipType", Vic3(StagedShipsWithType), Args::Args(&[]), Vic3(ShipType)),
    ("GetShipType", Vic3(SupplyShipConstruction), Args::Args(&[]), Vic3(ShipType)),
    ("GetShipType", Vic3(TreatyShipFilter), Args::Args(&[]), Vic3(ShipType)),
    ("GetShipTypeFilterList", Vic3(ArticleDraft), Args::Args(&[]), Vic3(TreatyShipFilterList)),
    ("GetShipViewer", Vic3(ShipDesignerPopup), Args::Args(&[]), Vic3(ShipViewer)),
    ("GetShipViewer", Vic3(ShipPanel), Args::Args(&[]), Vic3(ShipViewer)),
    ...
    ("GetSlot", Vic3(ShipDesignerModSlot), Args::Args(&[]), Vic3(ShipModificationSlotType)),
    ("GetSlotType", Vic3(ShipModificationType), Args::Args(&[]), Vic3(ShipModificationSlotType)),
    ...
    ("GetStateModifier", Vic3(InterestTierType), Args::Args(&[]), Vic3(Modifier)),
    ...
    ("GetStrait", Scope, Args::Args(&[]), Vic3(Strait)),
    ("GetStrait", Vic3(StraitMarker), Args::Args(&[]), Vic3(Strait)),
    ("GetStrait", Vic3(StraitPanel), Args::Args(&[]), Vic3(Strait)),
    ("GetStraitDefinition", Scope, Args::Args(&[]), Vic3(StraitDefinition)),
    ...
    ("GetStrategicRegion", Vic3(StrategicRegionPanel), Args::Args(&[]), Vic3(StrategicRegion)),
    ...
    ("GetSupplyHub", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(State)),
    ...
    ("GetTarget", Vic3(BattleLogEntry), Args::Args(&[]), Vic3(Ship)),
    ...
    ("GetTargetFleet", Vic3(Ship), Args::Args(&[]), Vic3(MilitaryFormation)),
    ...
    ("GetTargetState", Vic3(TransportPlannerPopup), Args::Args(&[]), Vic3(State)),
    ...
    ("GetTemplate", Vic3(NavalBattleShipTemplateGroup), Args::Args(&[]), Vic3(ShipTemplate)),
    ("GetTemplate", Vic3(Ship), Args::Args(&[]), Vic3(ShipTemplate)),
    ("GetTemplate", Vic3(ShipDesignerPopup), Args::Args(&[]), Vic3(ShipTemplate)),
    ("GetTemplateEdited", Vic3(ShipDesignerPopup), Args::Args(&[]), Vic3(ShipTemplate)),
    ...
    ("GetType", Vic3(NavalMission), Args::Args(&[]), Vic3(NavalMissionType)),
    ...
    ("GetType", Vic3(Ship), Args::Args(&[]), Vic3(ShipType)),
    ("GetType", Vic3(ShipTemplate), Args::Args(&[]), Vic3(ShipType)),
    ("GetType", Vic3(WarGoal), Args::Args(&[]), Vic3(WarGoalType)),
    ("GetType", Vic3(WarGoalDraft), Args::Args(&[]), Vic3(WarGoalType)),
    ("GetTypeOfShipsSelected", Vic3(ShipSelection), Args::Args(&[]), Vic3(ShipType)),
    ...
    ("GetWinner", Vic3(NavalBattle), Args::Args(&[]), Vic3(Country)),
    ...
    ("MakeScope", Vic3(CharacterRole), Args::Args(&[]), Scope),
    ...
    ("MakeScope", Vic3(InterestTierType), Args::Args(&[]), Scope),
    ...
    ("MakeScope", Vic3(NavalBattle), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(NavalMission), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(NavalMissionType), Args::Args(&[]), Scope),
    ...
    ("MakeScope", Vic3(Ship), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(ShipGroup), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(ShipModificationType), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(ShipType), Args::Args(&[]), Scope),
    ...
    ("MakeScope", Vic3(Strait), Args::Args(&[]), Scope),
    ("MakeScope", Vic3(StraitDefinition), Args::Args(&[]), Scope),
    ...
    ("sCR", TopScope, Args::Args(&[DType(Unknown)]), Vic3(CharacterRole)),
    ...
    ("sCharacterRole", TopScope, Args::Args(&[DType(Unknown)]), Vic3(CharacterRole)),
    ...
    ("sInterestTierType", TopScope, Args::Args(&[DType(Unknown)]), Vic3(InterestTierType)),
    ...
    ("sStrait", TopScope, Args::Args(&[DType(Unknown)]), Vic3(Strait)),
